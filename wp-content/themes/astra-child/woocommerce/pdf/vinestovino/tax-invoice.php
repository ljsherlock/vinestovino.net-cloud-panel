	...
	<tr>
		...
		<td class="order-data">
			<table>
				...
				<?php endif; ?>
				<tr class="order-tax">
					<th><?php _e( 'VAT Number:', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
					<td><?= "0205558021126"; ?></td>
				</tr>
				...
				<?php if ( $payment_method = 'Direct Bank Transfer' ) : ?>
					<td><h3><?php _e( 'Payment Details:', 'woocommerce-pdf-invoices-packing-slips' ); ?></h3></td>
				...
				<table class="totals">
					<tfoot>
						<tr class="-1">
							...
							<td class="price"><span class="totals-price"><?= count($this->get_order_items()) ?></span></td>
						</tr>
...
<table class="signature">
	<tr class="title">
		...
		<td class="spacer">&nbsp;</td>
		<td style="border-bottom: 1px dotted;">Money Received</td>
	</tr>
	<tr class="date">
		<td><?php $this->invoice_date(); ?></td>
		<td class="spacer">&nbsp;</td>
