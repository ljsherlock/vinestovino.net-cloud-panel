	...
	class WC_Discount_Rules_Table extends WP_List_Table {
                ...
                if ( wcdrfc_fs()->is__premium_only() ) {
                    if ( wcdrfc_fs()->can_use_premium_code() ) {
                        if( 'fixed' === $amount_type ) {
                            ...
                            return $amount . '%';
                        } elseif( 'bogo' === $amount_type ) {
                            return strtoupper('free');
                        } elseif( 'adjustment' === $amount_type ) {
                            $adjustment_amount = get_post_meta( $item->ID, 'dpad_settings_adjustment_cost', true );
        ...
        public function search_box( $text, $input_id ) {
            ...
            <p class="search-box">
                ...
                <input type="search" id="<?php echo esc_attr( $input_id ); ?>" name="s" value="<?php _admin_search_query(); ?>" placeholder="<?php esc_html_e( 'Discount title', 'woo-conditional-discount-rules-for-checkout' ); ?>" />
