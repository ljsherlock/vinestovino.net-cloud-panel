...
echo  esc_url( wcdrfc_fs()->get_upgrade_url() ) ;
?>">
                                    <?php 
esc_html_e( 'Upgrade', 'woo-conditional-discount-rules-for-checkout' );
?>
                                </a>
                            </div>
                        <?php 
...
?>"><?php 
esc_html_e( 'Dashboard', 'woo-conditional-discount-rules-for-checkout' );
?></a>
                                </li>
                            <?php 
?>
...
?>"><?php 
esc_html_e( 'About', 'woo-conditional-discount-rules-for-checkout' );
?></a></li>
                            <li><a class="<?php 
echo  esc_attr( $dpad_information ) ;
?>" href="<?php 
echo  esc_url( add_query_arg( array(
    'page' => 'wcdrfc-page-information',
), $admin_url ) ) ;
?>"><?php 
...
if ( !(wcdrfc_fs()->is__premium_only() && wcdrfc_fs()->can_use_premium_code()) ) {
    ...
    ?>"><?php 
    esc_html_e( 'Account', 'woo-conditional-discount-rules-for-checkout' );
    ?></a>
                                    </li>
                                    <?php 
}
...
?>" target="_blank"><?php 
esc_html_e( 'Shop Plugins', 'woo-conditional-discount-rules-for-checkout' );
?></a></li>
                        </ul>
                    </div>