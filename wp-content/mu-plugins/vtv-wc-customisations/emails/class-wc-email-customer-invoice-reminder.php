<?php
/**
 * Class WC_Email_Customer_Invoice_Reminder file.
 *
...
if ( ! class_exists( 'WC_Email_Customer_Invoice_Reminder', false ) ) :
	 ...
	 *
	 * @class       WC_Email_Customer_Invoice_Reminder
	 * @version     3.5.0
	 * @package     WooCommerce\Classes\Emails
	 * @extends     WC_Email
	 */
	class WC_Email_Customer_Invoice_Reminder extends WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id             = 'customer_invoice_reminder';
			$this->customer_email = true;
			$this->title          = __( 'Customer invoice Reminder', 'woocommerce' );
			$this->description    = __( 'An email to remind a user to settle an unpaid order.', 'woocommerce' );
			$this->template_html  = 'emails/customer-invoice-reminder.php';
			$this->template_plain = 'emails/plain/customer-invoice-reminder.php';
			$this->placeholders   = array(
				'{order_date}'   => '',
				'{order_number}' => '',
			);
			$this->template_base  = VTV_WC_CUSTOMISATIONS_DIR . 'templates/';
		...
		public function get_default_subject( $paid = false ) {
			if ( $paid ) {
				...
				return __( 'Waiting on Payment: Wine Order: #{order_number}  ', 'woocommerce' );
			}
		}
...
return new WC_Email_Customer_Invoice_Reminder();
